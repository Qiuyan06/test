	...
	export default {
		...
		methods: {
			initObserver() {
				...
				// #ifdef H5
				this.stickyTop = this.offsetTop != 0 ? Number(this.offsetTop) + Number(this.h5NavHeight) + statusBarHeight : this.h5NavHeight;
				// #endif
				// #ifndef H5
				this.stickyTop = this.offsetTop != 0 ? Number(this.offsetTop) + statusBarHeight : 0;
				// #endif
