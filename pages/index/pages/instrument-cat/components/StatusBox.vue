        ...
        <view class="mian">
            ...
            <view class="details">
                <view class="details-item">
                    ...
                    <text class="label">电流  {{outcurrent}}A</text>
                    <view class="line"></view>
<!--                    <text class="val">安全阀值  220V ≤ x ≤ 220V</text>-->
                </view>
                <view class="details-item">
                    <text class="iconfont">&#xe667;</text>
                    <text class="label">电压 {{outvoltage}}V</text>
                    <view class="line"></view>
                    <text class="val">安全阀值  {{recordData ? icInstruCount && icInstruCount.minOutvoltage || 0 : 0}}V ≤ x ≤ {{recordData ? icInstruCount && icInstruCount.maxOutvoltage || 0 : 0}}V</text>
                </view>
            </view>
            <view class="statistics">
                <view class="statistics-item">
                    <text class="val">{{recordData ? recordData.alarmRecord || 0 : 0}}</text>
                    <text class="label">警报</text>
                </view>
                <!--<view class="statistics-item">
                    <text class="val">{{recordData ? recordData.repairRecord || 0 : 0}}</text>
