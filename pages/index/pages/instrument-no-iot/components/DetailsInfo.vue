	...
	export default {
		...
		methods: {
			toInfo() {
				...
				uni.navigateTo({
					url: `/pages/index/pages/instrument-no-iot/info-page?${instruId}${dbName}${jurisdiction}${instruNum}`
				});
			},
			toRecord(tabsCurrent) {
				...
				uni.navigateTo({
					url: `/pages/index/pages/device-record/index?${instruId}${dbName}${jurisdiction}${current}`
				});
			}
		}
	}
